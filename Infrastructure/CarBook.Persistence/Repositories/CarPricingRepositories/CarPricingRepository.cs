...
namespace CarBook.Persistence.Repositories.CarPricingRepositories
{
    public class CarPricingRepository : ICarPricingRepository
    {
        ...
        public List<CarPricingViewModel> GetCarPricingWithTimePeriod1()
        {
            ...
            {
                command.CommandText = "Select * From (Select Model,Name,CoverImageUrl,PricingID,Amount " +
                    "From CarPricings Inner Join Cars On Cars.CarID=CarPricings.CarId Inner Join Brands On Brands.BrandID=Cars.BrandID) " +
